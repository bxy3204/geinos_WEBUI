...
class Users extends Component {
  ...
  render () {
    ...
    const emailLink = this.state.email; const emailIsValid = emailLink
    const passwordLink = this.state.password; const passwordIsValid = passwordLink && passwordLink.length >= 6
    const passwordVerifyLink = this.state.passwordverify; const verifyPasswordIsValid = passwordLink === passwordVerifyLink
    var complete = false
      ...
      <div className="container">
        ...
        <form className="form-createuser">
          ...
          <FormGroupCreate
            ...
            type="text"
          />
          <div className = 'error-placeholder'> { passwordIsValid && this.state.password !== this.state.passwordverify ? '' : ''}
            <FormGroupCreate
